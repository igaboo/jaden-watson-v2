      ...
      <Animate>
        ...
        <div className={styles.options}>
          <div className={styles.option}>
            ...
            <p>
              being both the designer as well as the developer allows for
              seamless transitions between concept and reality - no surprises.
            </p>
            <hr />
            <p className="heavy">Unlimited customization</p>
            <p>
              no WordPress or Shopify templates here - you decide how your
              website will look.
            </p>
          </div>
          <div className={styles.option}>
            <p>
              I build fast, efficient, and scalable design systems to ensure
            ...
            <p>
              ...
              - bells and whistles are fun, but only when they don't get in the
              way.
            </p>
            <hr />
            <p className="heavy">Code that works everywhere</p>
            <p>
              using JavaScript, HTML, and CSS, your website will work on all
              major web browsers - whether it be on a mobile device, tablet, or
              computer.
            </p>
          </div>
        </div>
